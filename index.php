...
<html lang="en">
  <head>
    ...
    <title>MTS SYEKH SUBAKIR</title>
  </head>
  <body>
    <header class="wrapper">
      <div class="top-bar1"></div>
      <div class="top-bar2">
        <h4 class="top">OSIS</h4>
    ...
    <section id="home" class="container-fluid p-0">
      ...
      <div class="row to-point">
        ...
        >
          ...
          <p class="pimt">
            Sikap kerja sama antara satu dengan yang lain adalah hal yang diutamakan dalam organisasi kami.
          </p>
        </div>
        <div
        ...
        >
          ...
          <p class="pimt">
            Semangat berorganisasi merupakan aspek penting yang kami bangun bersama untuk kemajuan sekolah kami.
          </p>
        </div>
        <div
          class="col for-point bg-warning custom-height d-flex flex-column justify-content-center align-items-center text-center"
        >
          ...
          <p class="pimt">
            Kami selalu mengutamakan aspek spiritual dalam setiap kegiatan program organisasi. Sebagai makhluk yang percaya adanya pencipta.
          </p>
        </div>
      </div>
    </section>
    ...
    <section id="profile" class="row profiles">
      ...
      <div class="col profile1 d-flex flex-column justify-content-start pt-5 ps-5">
        <h3 class="w-100 a-b">PROFIL&nbsp;<b class="b-a">ORGANISASI</b></h3>
        <div class="hr"></div>
        <p class="p-ab">
          Organisasi Siswa Intra Sekolah atau OSIS MTS Syekh Subakir 1 Nglegok memiliki prinsip kerja untuk menjaga kerukunan, ketertiban, dan keamanan di lingkungan sekolah MTS Syekh Subakir 1 Nglegok.
        </p>
        <div class="programs">
          <h3 class="progker-a">PROGRAM&nbsp;<b class="progker-b">KERJA</b></h3>
          <div class="hr"></div>
          <ul class="progs">
              <li><i class="fa-regular fa-circle-check" style="color: #ffbc05;"></i>&nbsp;PERBAIKAN SPOT TAMAN</li>
              <li><i class="fa-regular fa-circle-check" style="color: #ffbc05;"></i>&nbsp;PEMBENTUKAN TIM ESPORT</li>
              <li><i class="fa-regular fa-circle-check" style="color: #ffbc05;"></i>&nbsp;LOMBA AGUSTUSAN</li>
              <li><i class="fa-regular fa-circle-check" style="color: #ffbc05;"></i>&nbsp;LOMBA KESENIAN ANTAR KELAS</li>
              <li><i class="fa-regular fa-circle-check" style="color: #ffbc05;"></i>&nbsp;PEMBENTUKAN TIM DIREKSI</li>
              <li><i class="fa-regular fa-circle-check" style="color: #ffbc05;"></i>&nbsp;ACARA MILAD TAHUNAN SEKOLAH</li>
          </ul>
    ...
    <section id="visimi" class="bl-bg">
      <div class="vision-mision">
        ...
        <p class="vismis">Berikut adalah visi dan misi Organisasi</p>
      </div>
      <div class="centoner">
        <div class="cardu" style="--clr: #F9C72C;">
          <div class="cantont">
            <h2>VISI</h2>
            <p>"Mewujudkan MTS Syekh Subakir 1 Nglegok yang aktif, kreatif, inovatif, dan profesional. Serta menjadikan OSIS sebagai wadah yang menampung segala bakat, potensi, dan keahlian yang dimiliki siswa."</p>
          </div>
          <div class="imgBx">
        ...
        <div class="cardu" style="--clr: #F9C72C;">
          <div class="cantont">
            <h2>MISI</h2>
            <ol type="1">
              <li>Berpartisipasi aktif dalam ajang perlombaan akademik maupun non akademik di lingkungan sekolah dan masyarakat umum.</li>
              <li>Meningkatkan kedisiplinan siswa-siswi melalui peraturan yang tegas dan tangung jawab.</li>
              <li>Menyelenggarakan suatu kegiatan ekstrakulikuler yang unik, kreatif, dan menarik bagi siswa siswi.</li>
            </ol>
          </div>
          <div class="imgBx">
    ...
    <section id="structure" class="structure">
      <div class="structure-ttl">
        ...
        <p class="str-des">Berikut adalah struktur kepengurusan dari organisasi</p>
      </div>
    ...
    <section id="blogs" class="blogs">
      <div class="ttl-blogs">
        ...
        <p class="des-blogs">Berikut adalah informasi dan berita terbaru dari organisasi kami.</p>
      </div>
    ...
    <div class="footer">
      <div class="foot-1">
        <div class="ftr-1">
          <h2 class="ftr-ttl">OSIS</h2>
          <h3 class="cnt-ftr">Contact Us</h3>
          <p class="des-ftr">osismatsabang2023@gmail.com<br>Jalan Pesantren No. 01 Kec. Nglegok Kab. Blitar</p>
        </div>
        <div class="ftr-2">
